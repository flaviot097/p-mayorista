  ...
  dataFilter.forEach((jsonDatos) => {
    ...
    const containerCards = `<div loading="lazy" class="wow fadeInUp" id="${jsonDatos.codigo}">
                            <div class="card card-body border-0 text-center shadow pt-5 tarjeta-productos">
                              ...
                              <button id=${jsonDatos.codigo} class="btn-agregar-carrito"><img width="32" height="30"
    ...
    btnAgregarcarrito.forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        document.cookie = `carrito=` + arreglo + ";max-age=3600;";
      });
    });
...
window.addEventListener("scroll", () => {
  ...
  const divVaciar = document.querySelectorAll(".form-action-redirection");
