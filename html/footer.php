<div class="page-footer-section bg-dark fg-white">
    <div class="container">
        <div class="row mb-5 py-3">
            ...
            <div class="col-md-6 col-lg-4 py-3">
                <h5 class="mb-3">¿quieres que te contactemos?</h5>
                <p>Deje aqui su email y nos comunicaremos con usted.</p>
                <form method="POST">
        ...
        <div class="row">
            <div class="col-12 col-md-6 py-2">
                ...
                <p class="d-inline-block ml-2">
                    Copyright &copy;
                    <a href="" class="fg-white fw-medium">Flavio T.</a> todos los
                    derechos reservados.
                </p>
            </div>
            <div class="col-12 col-md-6 py-2">
